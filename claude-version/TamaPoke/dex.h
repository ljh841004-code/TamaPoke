...
// tipo primario (gen 1) para las batallas
enum : uint8_t { PT_NORMAL, PT_FIRE, PT_WATER, PT_GRASS, PT_ELECTRIC, PT_ICE, PT_FIGHT, PT_POISON, PT_GROUND, PT_PSYCHIC, PT_BUG, PT_ROCK, PT_GHOST, PT_DRAGON, PT_COUNT };
...
static const DexEntry DEX_TBL[DEX_COUNT + 1] = {
  ...
  { "GOLBAT", 0, 0, R_EVO, 0x8A73, 75, 80, 70, 90, 0, PT_POISON },  // 42 veneno
  ...
  { "ONIX", 0, 0, R_RARO, 0x9407, 35, 45, 160, 70, 4, PT_ROCK },  // 95 roca
  ...
  { "CHANSEY", 0, 0, R_RARO, 0x8C4D, 250, 5, 5, 50, 0, PT_NORMAL },  // 113 normal
  ...
  { "SEADRA", 0, 0, R_EVO, 0x4C98, 55, 65, 95, 85, 1, PT_WATER },  // 117 agua
  ...
  { "SCYTHER", 0, 0, R_RARO, 0x7CC4, 70, 110, 80, 105, 2, PT_BUG },  // 123 bicho
  ...
  { "PORYGON", 0, 0, R_RARO, 0x8C4D, 65, 60, 70, 40, 0, PT_NORMAL },  // 137 normal
