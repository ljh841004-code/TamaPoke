...
static const char *const STRINGS[LANG_COUNT][STR_COUNT] = {
  // ---------------- ES ----------------
  {
    ...
    "%s   DIA %lu", "toca el nombre: renombrar",
  ...
  // ---------------- FR ----------------
  {
    ...
    "%s   JOUR %lu", "touche le nom: renommer",
  ...
  // Un byte por caracter: strlen() sigue midiendo bien y el centrado no cambia.
  {
    ...
    "%s   TAG %lu", "Name tippen: umbenennen",
  ...
  // ---------------- IT ----------------
  {
    ...
    "%s   GIORNO %lu", "tocca il nome: rinomina",
  ...
  // ---------------- PT ----------------
  {
    ...
    "%s   DIA %lu", "toque no nome: renomear",
  ...
  // silencio que valor cae en que hueco.
  {
    ...
    "메달!", "최고예요!", "%u일 연속!",
    "연속 %u  최고 %u", "유대감", "좋아함 ???", "빨간 열매", "파란 열매", "초록 열매",
    "%s   %lu일차", "이름 탭: 이름변경",
    "배틀", "공격", "방어", "속도", "무게", "힘 훈련",
    "메달 %d/%d", "탭: 뒤로",
    "이름:", "탭하면 뒤로",
